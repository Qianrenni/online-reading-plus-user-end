  ...
  <div class=" personal-center-container container-row-768-column">
    <div class="personal-center-left">
      <div class=" personal-center-left-top bg-card shadow-black">
        <QAvatar
          size="100px"
          :url="userStore.getUser?.avatar==''?'/figure.webp':userStore.getUser?.avatar"
        />
        ...
        <QFormButton
          type="button"
          class=" button-outline padding-24rem container-w100"
        ...
        <QFormButton
          type="button"
          class=" padding-24rem exit-button container-w100" 
          @click="()=>exitHandler()"
        >
          <span>退出登录</span>
        </QFormButton>
          ...
          <div class="personal-center-current-read-content">
            ...
            <p class=" container gap-fourth">
              <QIcon
                ...
                size="14px"
              />
            </p><h5>{{ histortItem.author }}</h5>
            <div
              class=" container-column gap-half"
