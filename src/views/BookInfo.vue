    ...
    <div>
      <div class="book-info-container-center  bg-card shadow-black">
        ...
        <div class="book-info-meta text-secondary">
          ...
          <p
            v-if="book.tags"
            class=" container gap-fourth container-wrap"
          >
            <span
          ...
          <div class=" container-wrap gap-half">
            <div class=" container gap-half">
              <QIcon
                icon="Book"
                size="16px"
              />
      ...
      <div class=" container-w100  shadow-black  bg-card   radius-rem">
        ...
        <div
          v-if="tabIndex===0"
          class="book-info-description text-secondary"
        >
        ...
        <div
          v-if="tabIndex===1"
          class="book-info-catalog scroll-container"
        >
          <p
      ...
      <div class="radius-half-rem book-info-fast-catalog  bg-card shadow-black">
        ...
        >
          <QLazyImage
            ...
            :height="96"
            :width="72"
            class=" radius-half-rem"
          />
          <div class="book-info-recommend-item-meta">
            <p class=" text-secondary">
              {{ item.name }}
            </p>
            <p class=" text-description text-08rem  text-two-line">
              &nbsp;&nbsp;{{ item.description }}
            </p>
          </div>
        </div>
